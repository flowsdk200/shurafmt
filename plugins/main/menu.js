...
export const MENU = {
    ...
    Search: ['apkcombo', 'apkmirror', 'apkmody', 'apkpure', 'appstore', 'appteka', 'aptoide', 'bilibili', 'bing', 'bingimg', 'bluearchive', 'brave', 'cekfakta', 'cookpad', 'cookpadread', 'donghua', 'fdroid', 'github', 'google', 'gsmarena', 'komikindo', 'linkedin', 'mangatoon', 'mangatoonread', 'npm', 'pexels', 'pin', 'pixiv', 'playstore', 'sfile', 'shopee', 'softmany', 'soundcloud', 'spsearch', 'tokopedia', 'ttsearch', 'turnbackhoax', 'unsplash', 'wattpad', 'wattpadread', 'webtoons', 'webtoonread', 'wikimedia', 'wikipedia', 'yahoo', 'ytsearch'],
    Tools: ['brat', 'cekcuaca', 'emojimix', 'gempa', 'get', 'getpp', 'hd', 'hdvideo', 'idch', 'iqc', 'jadwalsholat', 'ocr', 'removebg', 'rvo', 'shorturl', 'smeme', 'sprl', 'ssweb', 'sticker', 'swm', 'tgsticker', 'tinycc', 'totalfitur', 'tourl', 'translate', 'upscalemedia', 'videyup'],
    ...
    News: ['abc', 'aljazeera', 'antara', 'apnews', 'arstechnica', 'bbc', 'bbcworld', 'beritasatu', 'bisnis', 'bola', 'cbc', 'cna', 'cnbc', 'cnbcid', 'cnn', 'cnnid', 'cnet', 'detik', 'engadget', 'euronews', 'fajar', 'fortune', 'foxnews', 'france24', 'globalnews', 'guardian', 'hackernews', 'harianjogja', 'idntimes', 'independent', 'indozone', 'inews', 'jawapos', 'jogja', 'jpn', 'katadata', 'kompas', 'kontan', 'kumparan', 'liputan6', 'marketwatch', 'medcom', 'merdeka', 'nbcnews', 'npr', 'nytimes', 'okezone', 'pbs', 'republika', 'rmol', 'scmp', 'slashdot', 'skynews', 'solnews', 'sindonews', 'suara', 'techcrunch', 'tempo', 'thehill', 'thetimes', 'theverge', 'tribun', 'tvone', 'validnews', 'vice', 'viva', 'vivagoal', 'voa', 'washpost', 'zdnet'],
