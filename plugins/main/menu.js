...
export const MENU = {
    ...
    Tools: ['brat', 'cekcuaca', 'emojimix', 'gempa', 'get', 'getpp', 'hd', 'hdvideo', 'idch', 'iqc', 'jadwalsholat', 'ocr', 'removebg', 'rvo', 'shorturl', 'smeme', 'sprl', 'ssweb', 'sticker', 'swm', 'tgsticker', 'tinycc', 'totalfitur', 'tourl', 'translate', 'uploadid', 'videyup'],
    ...
    Owner: ['addban', 'addcoin', 'addlimit', 'addowner', 'addprem', 'addrespon', 'autoread', 'ceklimit', 'ceksaldo', 'delban', 'dellimit', 'delowner', 'delppbot', 'delprem', 'delrespon', 'listban', 'listgc', 'listowner', 'listprem', 'listrespon', 'onlygrup', 'onlyowner', 'onlypc', 'onlyprem', 'public', 'quoted', 'resetdb', 'self', 'setppbot'],
