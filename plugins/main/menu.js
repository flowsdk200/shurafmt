...
export const MENU = {
    ...
    Search: ['apkcombo', 'apkmirror', 'apkmody', 'apkpure', 'appstore', 'appteka', 'aptoide', 'bilibili', 'bing', 'bingimg', 'bluearchive', 'brave', 'cekfakta', 'cookpad', 'cookpadread', 'fdroid', 'github', 'google', 'gsmarena', 'komikindo', 'linkedin', 'mangatoon', 'mangatoonread', 'npm', 'pexels', 'pin', 'pixiv', 'playstore', 'sfile', 'softmany', 'soundcloud', 'spsearch', 'tokopedia', 'ttsearch', 'turnbackhoax', 'unsplash', 'wattpad', 'wattpadread', 'webtoons', 'webtoonread', 'wikimedia', 'wikipedia', 'yahoo', 'ytsearch'],
