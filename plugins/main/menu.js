...
export const MENU = {
    ...
    Group: ['add', 'addwarn', 'afk', 'antibot', 'antilinkch', 'antilinkgc', 'antiluar', 'antispam', 'close', 'delete', 'delppgc', 'delwarn', 'demote', 'goodbye', 'hidetag', 'kick', 'listwarn', 'open', 'promote', 'setclose', 'setgoodbye', 'setopen', 'setppgc', 'setwelcome', 'tagall', 'welcome'],
