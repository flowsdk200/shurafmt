...
export const MENU = {
    ...
    Owner: ['addban', 'addlimit', 'addowner', 'addprem', 'addrespon', 'autoread', 'ceklimit', 'ceksaldo', 'delban', 'dellimit', 'delowner', 'delppbot', 'delprem', 'delrespon', 'listban', 'listgc', 'listowner', 'listprem', 'listrespon', 'onlygrup', 'onlyowner', 'onlypc', 'onlyprem', 'public', 'quoted', 'resetdb', 'self', 'setppbot', 'verif'],
