...
export default {
    ...
    execute: async ({ sock, msg, react, useLimit }) => {
        ...
        try {
            ...
            if (!items.length) {
                await react('❌')
                return sock.sendMessage(jid, { text: '⚠️ Tidak ada berita ditemukan dari BeritaSatu.' }, { quoted: msg })
            }
            ...
            for (const item of items) {
                ...
                const merged = { ...item, description: meta.description || '-' }
            ...
            if (!firstImage) {
                await react('❌')
                return sock.sendMessage(jid, { text: '❌ BeritaSatu: Tidak ada gambar valid yang bisa diambil untuk ditampilkan.' }, { quoted: msg })
            }
            ...
            await sock.sendMessage(jid, {
                text: `❌ Gagal ambil berita BeritaSatu: ${err.message}`
            }, { quoted: msg })
        }
    }
}
